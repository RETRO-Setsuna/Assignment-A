class Main {
    public static void main(String[] args) {
        ...
        shop.getInventory().addChocolate(new NormalChocolate("N004", "Cookies & Cream", 13.50, Size.XL,
                Sweetness.SEVENTY_FIVE, Types.COOKIE_AND_CREAM, Fillings.NUTS, Toppings.EXTRA_CHOCOLATE));

        shop.getInventory().addChocolate(new NormalChocolate("N005", "Caramel Milk", 11.00, Size.M, Sweetness.FIFTY,
        ...
        shop.getInventory().addChocolate(new CustomChocolate("C003", "Berry Milk", 11.50, Size.M, Sweetness.FIFTY,
        ...
        shop.getInventory().addChocolate(new CustomChocolate("C006", "Nut Explosion", 13.00, Size.L, Sweetness.FIFTY,
